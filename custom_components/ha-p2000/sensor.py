...
SCAN_INTERVAL = timedelta(minutes=1)  # Update elke 1 minuten
...
def setup_platform(hass, config, add_entities, discovery_info=None):
    ...
    add_entities([P3000Sensor(api, name, icon, apiFilter)])

class P3000Sensor(SensorEntity):
